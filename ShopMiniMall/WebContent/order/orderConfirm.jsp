...
<!-- 수정 부분 -->
<form action="CartOrderDoneServlet" method="get" name="myForm">
<!-- hidden 처리-->
		...
		<td>
			<table width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="td_default" align="center" width="80"><%=gPrice %></td>
					<td class="td_default" align="center" width="80"><%=gAmount %></td>
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="1"
				...
				<tr>
					...
					<td height="35" class="td_default">
						...
						maxlength="200" value="<%=addr1%>" readonly></input><br> <input class="input_default" type="text" id="maddress2"
			size="35" maxlength="200" value="<%=addr2%>" readonly></input>
		</td>
	</tr>
